"This code is adapted and modified from https://github.com/tobyperrett/trx"
import torch
import numpy as np
import argparse
import os
...
class Learner:
    def __init__(self):
        ...
        self.video_loader = torch.utils.data.DataLoader(self.vd, batch_size=1, num_workers=1) # self.args.num_workers)
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--dataset", choices=["ssv2", "kinetics", "hmdb", "ucf", "hri", "coax"], default="ssv2", help="Dataset to use.")
        ...
        parser.add_argument('--sch', nargs='+', type=int, help='iters to drop learning rate', default=[3000])
